...
inventari.innerHTML += `
<div class="item-inventari">
  <div class="item-inventari-icon"><img src="./img/superpocio.png" alt="Superpoció"></div>
  <div class="item-inventari-nom">Superpoció</div>
...
inventari.innerHTML += `
<div class="item-inventari">
  <div class="item-inventari-icon"><img src="./img/ultraball.png" alt="Ultra Ball"></div>
  <div class="item-inventari-nom">Ultra Ball</div>
...
let totalGastat = costPokeBalls + costSuperPocions + costUltraBalls;
...
resum.innerHTML = `
  ...
  <div class="resum-linia">
    <span>${quantitatSuperPocions}x Superpoció</span>
    <span>${costSuperPocions}₽</span>
  </div>
  <div class="resum-linia">
    <span>${quantitatUltraBalls}x Ultra Ball</span>
    <span>${costUltraBalls}₽</span>
  </div>
  <div class="resum-linia total">
    <span>TOTAL GASTAT</span>
    <span>${totalGastat}₽</span>
  </div>
`;
